...
/// @title Neural Beefy stablecoin pool integration
contract NeuralBeefyPoolIntegration is NeuralLPIntegration {
    ...
    function _farmHarvest(
        ...
        require(
            ...
            'NeuralBeefyPoolIntegration: Not enough rewards'
        );
    }
    ...
    function _claimRewards(
        ...
        require(
            ...
            'NeuralBeefyPoolIntegration: Not reward token'
        );
        _mergeRewards();
    ...
    function _handleFee(uint _minAmount) internal override {
        ...
        require(
            fee >= _minAmount,
            'NeuralBeefyPoolIntegration: Not enough fees'
        );
        totalUnhandledFee = 0;
