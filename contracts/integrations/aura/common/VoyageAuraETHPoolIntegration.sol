...
/// @title Voyage Aura stablecoin pool integration
contract VoyageAuraETHPoolIntegration is VoyageETHLPIntegration {
    ...
    function _claimRewards(
        ...
        require(
            ...
            'VoyageAuraPoolIntegration: Only WETH'
        );
        _mergeRewards();
        uint heldRewards = users[_msgSender()].heldRewards; // WETH
        require(
            heldRewards > _minAmount,
            'VoyageAuraPoolIntegration: Not enough rewards'
        );
    ...
    function _handleFee(uint _minAmount) internal override {
        ...
        require(
            fee >= _minAmount,
            'VoyageAuraPoolIntegration: Not enough fees'
        );
        totalUnhandledFee = 0;
