...
import 'contracts/integrations/convex/common/VoyageConvexPoolIntegration.sol';
import './common/ICurvePool.sol';

/// @title Voyage MIM-3CRV pool integration
contract VoyageMIM3CRVConvexIntegration is VoyageConvexPoolIntegration {
    ...
    constructor(
        address _oracle,
        address _feeHandler
    ) VoyageConvexPoolIntegration(40, _oracle, _feeHandler) {}
