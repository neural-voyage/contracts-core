...
import 'contracts/integrations/curve/common/VoyageCurveETHPoolIntegration.sol';

/// @title Voyage FRAX-3CRV pool integration
contract VoyageWethWeEthETHIntegration is VoyageCurveETHPoolIntegration {
    ...
    constructor(
        address _oracle,
        address _feeHandler
    ) VoyageCurveETHPoolIntegration(POOL, GAUGE, _oracle, _feeHandler) {}
}
