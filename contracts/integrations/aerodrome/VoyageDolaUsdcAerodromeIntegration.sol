...
import 'contracts/integrations/aerodrome/common/VoyageAerodromePoolIntegration.sol';

/// @title Voyage DOLA-USDC pool integration
contract VoyageDolaUsdcAerodromeIntegration is VoyageAerodromePoolIntegration {
    using SafeERC20 for IERC20;

    /// @dev pool specific addresses
    address private constant DOLA_USDC =
        0xf213F2D02837012dC0236cC105061e121bB03e37;
    address private constant DOLA_USDC_GAUGE =
    ...
    constructor(
        ...
        VoyageAerodromePoolIntegration(
            DOLA_USDC,
            DOLA_USDC_GAUGE,
            _oracle,
            _feeHandler
    ...
    function _depositStablecoin(
        ...
        require(
            ...
            'VoyageDolaUsdcAerodromeIntegration: Not enough result'
        );
    }
