...
import 'contracts/integrations/aerodrome/common/NeuralAerodromePoolIntegration.sol';

/// @title Neural DOLA-USDC pool integration
contract NeuralDolaUsdcAerodromeIntegration is NeuralAerodromePoolIntegration {
    ...
    constructor(
        ...
        NeuralAerodromePoolIntegration(
            DOLA_USDC,
            DOLA_USDC_GAUGE,
            _oracle,
            _feeHandler
