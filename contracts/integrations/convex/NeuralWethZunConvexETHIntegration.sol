...
import 'contracts/integrations/convex/common/NeuralConvexETHPoolIntegration.sol';
import './common/ICurvePool.sol';

/// @title Neural WETH-ZUN pool integration
contract NeuralWethZunConvexETHIntegration is NeuralConvexETHPoolIntegration {
    ...
    constructor(
        address _oracle,
        address _feeHandler
    ) NeuralConvexETHPoolIntegration(363, _oracle, _feeHandler) {}
