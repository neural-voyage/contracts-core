...
import 'contracts/integrations/aerodrome/common/VoyageAerodromeETHPoolIntegration.sol';

/// @title Voyage DOLA-USDC pool integration
contract VoyageWethRethAerodromeIntegration is
    VoyageAerodromeETHPoolIntegration
{
    ...
    function _withdrawStablecoin(
        ...
        require(
            ...
            'VoyageWethRethAerodromeIntegration: Not enough result'
        );
    }
